                  ...
                  <tr key={lead.id} onClick={() => onSelectLead(lead)}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-1">
                        {leadTags.length === 0 && <span className="text-[10px] text-muted-foreground">—</span>}
                        {leadTags.slice(0, 3).map((t: any) => (
                          <span key={t.id} className="text-[10px] px-1.5 py-0.5 rounded-full border inline-flex items-center gap-1"
                        ...
                        {leadTags.length > 3 && (
                          <span className="text-[10px] text-muted-foreground">+{leadTags.length - 3}</span>
                        )}
                      </div>
                    </td>
